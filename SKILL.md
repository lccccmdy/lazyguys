...
- 目录模板：`project-manager/templates/default-structure.yaml`
- 文件类型规则：`project-manager/rules/file-types.yaml`
- 智能路由：`project-manager/module-router.md`
- 扫描复盘：`project-manager/module-scan.md`
- 整理结构：`project-manager/module-organize.md`
- 初始化：`project-manager/module-init.md`
- 查询：`project-manager/module-query.md`
- 更新记忆：`project-manager/update-memory.md`